 ...
 */
@Service
public class WxFrontLegalManageServiceImpl implements WxFrontLegalManageService,BaseService {
    ...
    @Override
    public Boolean saveLegal(AddMedicalDTO addLegalDTO) {
    ...
    @Override
    public PageUtil<MedicalLegalListBO> listMedicalLegal(MedicalListQueryDTO query) {
